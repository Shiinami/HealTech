...
class halamanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dashboard.halaman.index')->with('success', 'Halaman berhasil ditambahkan');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('dashboard.halaman.index')->with('success', 'Berhasil memperbarui data');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('dashboard.halaman.index')->with('success', 'Data berhasil dihapus');
    }
}
